  ...
  return (
    <div className="mx-auto max-w-[700px] mt-8">
      ...
      <p className="my-8 text-md">
        ...
        million on CDs alone. So much money that during one point in time, the AOL logo was on 50%
        of CDs. Now that's a lot of CDs! A special gift will be given to any player who can bring us
        a CD with the AOL logo printed on it!
      </p>
      ...
      <p className="my-8 text-md">
        Hello. This is salad fingers. They like rusty spoons. They like to touch them. This
        phenomenal content from 2004 was named by the San Francisco Chronicle as one of the "Top 10"
        pop culteral phenomena the following year. To view all of salad fingers' delightfully spooky
        videos and introduce yourself to Hubert Cumberdale, Marjory Stewart-Baxter, and Jeremy
        Fisher follow{' '}
        <a
          className="text-blue-800 hover:text-blue-400"
      ...
      <p className="my-8 text-md">
        In order to understand this reference, you must already be the type of nerd that is beyond
        my capabilities. It's colloquially known as the Hyper Text Coffee Pot Control Protocol. You
        and I will both require the help of a special type of nerd to help us understand this
        programming joke. Have no fear; ultimate frisbee is full of this type of intelligent and
        cool person who is willing to share about RFC 2324. If you can't find one on your team, our
        team has plenty.
      </p>
      ...
      <p className="my-8 text-md">
        ...
        He is the patron saint of this team and all other comments will be considered blasphemy!
        Long live Al Gore! Long live the internet!{' '}
      </p>
      ...
      <p className="my-8 text-md">
        Doge. Good doge. Very bark. Such fluff. Nuff said. This popular meme sponsored an entire
        style of speaking some theorize is the future of American English. It's already taking over
        the crypto world. What can't this akita do?{' '}
      </p>
